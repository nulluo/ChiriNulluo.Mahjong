...
Namespace View
    Public Class TestForm
        ...
        Private Sub openTileSelectWindowFormButton_Click(sender As Object, e As EventArgs) Handles openTileSelectWindowFormButton.Click
            ...
            _tile0 = New PreCureCharacterTile("0301", "夢原のぞみ", "キュアドリーム", False)
            _tile1 = New PreCureCharacterTile("0302", "夏木りん", "キュアルージュ", False)
            _tile2 = New PreCureCharacterTile("0303", "春日野うらら", "キュアレモネード", False)
            _tile3 = New PreCureCharacterTile("0304", "秋元こまち", "キュアミント", False)
